...
specifics of `@forkroom/component-library` — `ExtendProps`, refs
...
In `@forkroom/component-library`, `ExtendProps<T, U>` enforces this: it strips
...
The detailed wrapping rules for `@forkroom/component-library` — props via
