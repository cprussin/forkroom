...
export const wrapperBase = css({
  ...
  // `[data-argo-field]:has(> label:hover) > div > *`. Anchoring on
  // Field's `data-argo-field` root scopes the rule to argo Fields — it
  ...
  "&:where([data-argo-field]:has(> label:hover) > div > *):has([data-control][data-invalid]):not(:has([data-control]:disabled)):not(:has([data-control]:is(:focus, [data-popup-open], [data-active])))":
    {
      borderColor: "danger",
    },
  "&:where([data-argo-field]:has(> label:hover) > div > *):not(:has([data-control]:disabled)):not(:has([data-control]:is(:focus, [data-popup-open], [data-active]))):not(:has([data-control][data-invalid]))":
    {
      borderColor: "muted",
    },
